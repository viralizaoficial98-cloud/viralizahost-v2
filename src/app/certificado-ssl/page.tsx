...
import { Lock, Shield, Zap, Globe, Search, RefreshCw, Server, Gauge } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Certificado SSL Grátis — ViralizaHost',
  description: 'Proteja o seu site com HTTPS e ganhe mais confiança dos seus visitantes.',
}

export default function CertificadoSSLPage() {
  const features = [
    { icon: Lock, title: 'HTTPS Automático', desc: 'Ativação automática do HTTPS em todos os domínios e subdomínios do seu plano.' },
    { icon: Shield, title: 'Criptografia 256-bit', desc: 'Encriptação de nível bancário para proteger os dados dos seus visitantes.' },
    { icon: Zap, title: 'Ativação Imediata', desc: 'SSL ativo em minutos após a contratação, sem configuração manual necessária.' },
    { icon: Globe, title: 'Wildcard Suportado', desc: 'Proteja o domínio principal e todos os subdomínios com um único certificado.' },
    { icon: Search, title: 'SEO Melhorado', desc: 'O Google prioriza sites HTTPS nos resultados de pesquisa — melhore o seu ranking.' },
    { icon: RefreshCw, title: 'Renovação Automática', desc: 'O certificado renova-se automaticamente antes de expirar, sem interrupções.' },
    { icon: Server, title: 'Compatibilidade Total', desc: 'Compatível com todos os browsers modernos e dispositivos móveis.' },
    { icon: Gauge, title: 'Zero Impacto na Velocidade', desc: 'TLS 1.3 otimizado para não afetar o tempo de carregamento do seu site.' },
  ]
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            ...
            <h1 className="text-4xl lg:text-6xl font-black text-white leading-tight mb-6">
              Certificado <span style={{ color: '#F5B700' }}>SSL</span> Grátis
            </h1>
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Proteja o seu site com HTTPS e ganhe mais confiança dos seus visitantes.
            </p>
