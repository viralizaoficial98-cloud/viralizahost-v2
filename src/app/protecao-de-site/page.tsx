...
import { Shield, Zap, Lock, AlertTriangle, Search, Activity, Globe, RefreshCw, Server } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Proteção Avançada do Site — ViralizaHost',
  description: 'Anti-malware, firewall e proteção DDoS para manter o seu site seguro.',
}

export default function ProtecaoDeSitePage() {
  const features = [
    { icon: Shield, title: 'Proteção DDoS', desc: 'Mitigação automática de ataques de negação de serviço em tempo real.' },
    { icon: Zap, title: 'Resposta Imediata', desc: 'Bloqueio instantâneo de ameaças identificadas sem interrupção do seu site.' },
    { icon: Lock, title: 'Firewall WAF', desc: 'Web Application Firewall que bloqueia SQL injection, XSS e outras vulnerabilidades.' },
    { icon: AlertTriangle, title: 'Alertas em Tempo Real', desc: 'Notificações imediatas por e-mail e SMS quando uma ameaça é detetada.' },
    { icon: Search, title: 'Scan de Malware', desc: 'Análise contínua de todos os ficheiros para detetar e remover código malicioso.' },
    { icon: Activity, title: 'Monitorização 24/7', desc: 'Vigilância constante da infraestrutura para detetar comportamentos anómalos.' },
    { icon: Globe, title: 'Proteção Global', desc: 'Rede de proteção distribuída globalmente para bloquear ameaças na origem.' },
    { icon: RefreshCw, title: 'Atualizações Automáticas', desc: 'Regras de segurança atualizadas automaticamente para combater novas ameaças.' },
    { icon: Server, title: 'Isolamento de Conta', desc: 'Contas isoladas para evitar contaminação cruzada entre utilizadores no servidor.' },
  ]
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            ...
            <h1 className="text-4xl lg:text-6xl font-black text-white leading-tight mb-6">
              Proteção <span style={{ color: '#F5B700' }}>Avançada</span> do Site
            </h1>
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Anti-malware, firewall e proteção DDoS para manter o seu site seguro.
            </p>
