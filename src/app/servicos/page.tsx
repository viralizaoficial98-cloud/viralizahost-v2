...
import { Server, Globe, Users, Cpu, HardDrive, Mail, Code, Lock, Shield, Zap, RefreshCw, Gauge } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Serviços — ViralizaHost',
  description: 'Da hospedagem ao e-mail corporativo, temos tudo que o seu negócio precisa.',
}

export default function ServicosPage() {
  const features = [
    { icon: Server, title: 'Hospedagem Web', desc: 'Planos de hospedagem partilhada e VPS com alta disponibilidade e suporte 24/7.' },
    { icon: Globe, title: 'Domínios', desc: 'Registo e gestão de domínios com DNS gerido e proteção de privacidade incluída.' },
    { icon: Mail, title: 'E-mail Corporativo', desc: 'Caixas de e-mail profissionais com domínio próprio, antispam e backup automático.' },
    { icon: Shield, title: 'Segurança', desc: 'Proteção DDoS, firewall, antivírus e monitorização contínua da sua infraestrutura.' },
    { icon: Cpu, title: 'Servidores VPS', desc: 'Servidores virtuais privados com root access, NVMe SSD e RAM DDR5.' },
    { icon: HardDrive, title: 'Backup Cloud', desc: 'Cópias de segurança diárias automáticas armazenadas em múltiplas localizações.' },
    { icon: Lock, title: 'Certificado SSL', desc: 'SSL gratuito com renovação automática para todos os planos de hospedagem.' },
    { icon: Code, title: 'Ferramentas Dev', desc: 'PHP, Node.js, Python, MySQL, PostgreSQL e Git disponíveis em todos os planos.' },
    { icon: Gauge, title: 'CDN Premium', desc: 'Rede de distribuição global para máxima velocidade de carregamento em todo o mundo.' },
  ]
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold mb-6" style={{ background: 'rgba(245,183,0,0.12)', border: '1px solid rgba(245,183,0,0.30)', color: '#F5B700' }}>
              SERVIÇOS VIRALIZAHOST
            </div>
            <h1 className="text-4xl lg:text-6xl font-black text-white leading-tight mb-6">
              Todos os nossos <span style={{ color: '#F5B700' }}>Serviços</span>
            </h1>
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Da hospedagem ao e-mail corporativo, temos tudo que o seu negócio precisa.
            </p>
