...
const fallbackPlans = [
  { id: 'wp-start', name: 'WordPress Start', price: 'Kz 24.900', priceAOA: 24900, period: '/mês', description: 'Para blogs e sites pessoais', features: ['1 site WordPress', '20 GB NVMe SSD', 'WordPress pré-instalado', 'SSL grátis', 'Backup semanal', 'Migração gratuita', 'Suporte 24/7'], notIncluded: ['CDN global', 'Criador IA', 'Staging'], cta: 'Começar com Start' },
  { id: 'wp-pro', name: 'WordPress Pro', price: 'Kz 49.900', priceAOA: 49900, period: '/mês', description: 'Para empresas e lojas WooCommerce', popular: true, badge: 'MAIS POPULAR', features: ['5 sites WordPress', '50 GB NVMe SSD', 'WordPress pré-instalado', 'SSL grátis', 'CDN global', 'Backup diário', 'Criador de Sites com IA', 'Otimização SEO automática', 'Migração gratuita', 'Suporte prioritário 24/7'], cta: 'Começar com Pro' },
  { id: 'wp-turbo', name: 'WordPress Turbo', price: 'Kz 99.900', priceAOA: 99900, period: '/mês', description: 'Máxima performance para alta demanda', badge: 'MELHOR VALOR', features: ['Sites WordPress ilimitados', '200 GB NVMe SSD', 'WordPress pré-instalado', 'SSL grátis', 'CDN global premium', 'Backup diário automático', 'Criador de Sites com IA', 'Otimização SEO avançada', 'Ambiente staging', 'Segurança reforçada', 'IP dedicado', 'Suporte premium 24/7'], cta: 'Começar com Turbo' },
]
