...
import { Monitor, Mail, Shield, Lock, Globe, Zap, Smartphone, Gauge, Activity } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Outlook 365 | ViralizaHost',
  description: 'O cliente de e-mail premium da Microsoft disponível com os nossos planos.',
}

const features = [
  { icon: Monitor, title: 'Outlook Desktop', desc: 'App completa para Windows e macOS.' },
  { icon: Mail, title: 'Gestão de E-mail', desc: 'Interface premium com foco em produtividade.' },
  { icon: Shield, title: 'Segurança Avançada', desc: 'Filtros Microsoft Defender integrados.' },
  { icon: Lock, title: 'Encriptação S/MIME', desc: 'Assinatura digital e encriptação de e-mails.' },
  { icon: Globe, title: 'Outlook Web App', desc: 'Acesso via browser com a mesma interface.' },
  { icon: Zap, title: 'Foco Prioritário', desc: 'IA organiza os e-mails mais importantes.' },
  { icon: Smartphone, title: 'Apps Mobile', desc: 'Outlook para iOS e Android incluído.' },
  { icon: Gauge, title: 'Calendário Teams', desc: 'Agenda integrada com Microsoft Teams.' },
  { icon: Activity, title: 'Suporte Microsoft', desc: 'Suporte técnico oficial da Microsoft.' },
]
      ...
      <main className="min-h-screen bg-white">
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            ...
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              O cliente de e-mail premium da Microsoft disponível com os nossos planos.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/register?plan=microsoft365" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl text-sm font-black transition-all duration-200 shadow-[0_8px_30px_rgba(245,183,0,0.35)]" style={{ background: '#F5B700', color: '#090909' }}>
                Obter Outlook →
              </Link>
        ...
        <section className="py-20" style={{ background: 'linear-gradient(160deg,#090909,#111)' }}>
          <div className="container mx-auto px-4 lg:px-8 text-center max-w-2xl">
            ...
            <Link href="/register?plan=microsoft365" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl text-sm font-black transition-all duration-200" style={{ background: '#F5B700', color: '#090909' }}>
              Obter Outlook →
            </Link>
          </div>
        </section>
