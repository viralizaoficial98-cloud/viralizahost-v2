...
import { Monitor, Users, Globe, HardDrive, Calendar, Smartphone, Shield, Lock, Zap } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Microsoft 365 Outlook — ViralizaHost',
  description: 'Outlook, Teams, OneDrive 1TB e todos os apps Microsoft para a sua empresa.',
}

export default function Microsoft365OutlookPage() {
  const features = [
    { icon: Monitor, title: 'Outlook Desktop', desc: 'O cliente de e-mail premium da Microsoft para Windows e macOS incluído.' },
    { icon: Users, title: 'Microsoft Teams', desc: 'Comunicação e colaboração em equipa com videoconferências ilimitadas.' },
    { icon: Globe, title: 'Apps Online', desc: 'Word, Excel, PowerPoint e OneNote acessíveis em qualquer browser.' },
    { icon: HardDrive, title: 'OneDrive 1TB', desc: 'Armazenamento em cloud de 1TB por utilizador para todos os ficheiros.' },
    { icon: Calendar, title: 'Calendário Partilhado', desc: 'Agenda integrada com Outlook e sincronizada em todos os dispositivos.' },
    { icon: Smartphone, title: 'Apps Mobile', desc: 'Apps Office para iOS e Android incluídas na subscrição.' },
    { icon: Shield, title: 'Microsoft Defender', desc: 'Proteção avançada contra ameaças com IA integrada da Microsoft.' },
    { icon: Lock, title: 'Conformidade GDPR', desc: 'Ferramentas de conformidade e proteção de dados empresariais.' },
    { icon: Zap, title: 'Ativação Imediata', desc: 'Licenças ativadas em minutos com suporte à configuração incluído.' },
  ]
  return (
    <>
      <Header />
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            ...
            <h1 className="text-4xl lg:text-6xl font-black text-white leading-tight mb-6">
              Microsoft 365 <span style={{ color: '#F5B700' }}>Outlook</span>
            </h1>
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Outlook, Teams, OneDrive 1TB e todos os apps Microsoft para a sua empresa.
            </p>
