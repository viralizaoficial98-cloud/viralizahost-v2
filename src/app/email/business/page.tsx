...
export const metadata: Metadata = {
  title: 'E-mail Business — 15 Contas — ViralizaHost',
  description: 'Para empresas em crescimento com necessidade de mais contas e segurança avançada.',
}

export default function EmailBusinessPage() {
  const features = [
    { icon: Mail, title: '15 Contas de E-mail', desc: 'Quinze endereços profissionais com o seu domínio personalizado para toda a equipa.' },
    { icon: Shield, title: 'DMARC Avançado', desc: 'Proteção DMARC configurada para evitar falsificações e melhorar a reputação do domínio.' },
    { icon: Lock, title: 'SPF / DKIM / DMARC', desc: 'Suite completa de autenticação de e-mail para máxima entregabilidade.' },
    { icon: Globe, title: 'IP Dedicado', desc: 'Endereço IP exclusivo para o envio de e-mails com melhor reputação de domínio.' },
    { icon: Zap, title: 'Envio Prioritário', desc: 'Fila de envio prioritária para garantir que os seus e-mails chegam primeiro.' },
    { icon: RefreshCw, title: 'Backup Diário', desc: 'Cópias de segurança diárias automáticas para nunca perder mensagens importantes.' },
    { icon: Archive, title: 'Arquivo Completo', desc: 'Arquivo completo de e-mails com pesquisa avançada e retenção ilimitada.' },
    { icon: Smartphone, title: 'Sync Mobile', desc: 'ActiveSync para iOS e Android com sincronização instantânea de e-mails.' },
    { icon: Gauge, title: 'Suporte Prioritário', desc: 'Acesso prioritário ao suporte técnico com tempo de resposta garantido.' },
  ]
  return (
    <>
      <Header />
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold mb-6" style={{ background: 'rgba(245,183,0,0.12)', border: '1px solid rgba(245,183,0,0.30)', color: '#F5B700' }}>
              PLANO BUSINESS — POPULAR
            </div>
            <h1 className="text-4xl lg:text-6xl font-black text-white leading-tight mb-6">
              E-mail Business <span style={{ color: '#F5B700' }}>— 15 Contas</span>
            </h1>
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Para empresas em crescimento com necessidade de mais contas e segurança avançada.
            </p>
