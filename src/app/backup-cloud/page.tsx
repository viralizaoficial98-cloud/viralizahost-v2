...
export const metadata: Metadata = {
  title: 'Backup Cloud Automático — ViralizaHost',
  description: 'Cópias de segurança diárias automáticas para proteger os seus dados.',
}

export default function BackupCloudPage() {
  const features = [
    { icon: Archive, title: 'Backup Diário', desc: 'Cópias de segurança automáticas todos os dias sem necessidade de configuração manual.' },
    { icon: Shield, title: 'Dados Protegidos', desc: 'Todos os backups são encriptados em repouso e em trânsito com AES-256.' },
    { icon: RefreshCw, title: 'Restauro Fácil', desc: 'Restaure o seu site ou base de dados com um clique direto do painel de controlo.' },
    { icon: Zap, title: 'Restauro Rápido', desc: 'Recuperação em minutos para minimizar o impacto de qualquer incidente.' },
    { icon: HardDrive, title: 'Armazenamento Redundante', desc: 'Backups guardados em múltiplas localizações geográficas para máxima segurança.' },
    { icon: Database, title: 'Bases de Dados', desc: 'Backup completo de todas as suas bases de dados MySQL e PostgreSQL.' },
    { icon: Lock, title: 'Encriptação Total', desc: 'Proteção por encriptação de ponta a ponta para todos os seus dados de backup.' },
    { icon: Clock, title: 'Retenção 30 Dias', desc: 'Mantenha backups dos últimos 30 dias para recuperar qualquer versão anterior.' },
    { icon: Globe, title: 'Acesso Global', desc: 'Aceda e gira os seus backups de qualquer lugar através do painel online.' },
  ]
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            ...
            <h1 className="text-4xl lg:text-6xl font-black text-white leading-tight mb-6">
              Backup <span style={{ color: '#F5B700' }}>Cloud Automático</span>
            </h1>
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Cópias de segurança diárias automáticas para proteger os seus dados.
            </p>
