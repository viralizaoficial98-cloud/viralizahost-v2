...
import { Gauge, Globe, Zap, Shield, Server, RefreshCw, Lock, Activity, Database } from 'lucide-react'

export const metadata: Metadata = {
  title: 'CDN Premium Global — ViralizaHost',
  description: 'Velocidade global com distribuição de conteúdo em mais de 50 pontos de presença.',
}

export default function CdnPremiumPage() {
  const features = [
    { icon: Gauge, title: 'Velocidade Máxima', desc: 'Conteúdo entregue a partir do ponto de presença mais próximo do visitante.' },
    { icon: Globe, title: '+50 PoPs Globais', desc: 'Rede global com mais de 50 pontos de presença em todos os continentes.' },
    { icon: Zap, title: 'Cache Inteligente', desc: 'Cache automático otimizado para reduzir latência e acelerar o carregamento.' },
    { icon: Shield, title: 'Proteção DDoS', desc: 'Camada de segurança CDN que absorve e mitiga ataques volumétricos.' },
    { icon: Server, title: 'Balanceamento de Carga', desc: 'Distribuição inteligente do tráfego para máxima disponibilidade e performance.' },
    { icon: RefreshCw, title: 'Purge Instantâneo', desc: 'Limpe o cache em segundos para publicar atualizações de conteúdo imediatamente.' },
    { icon: Lock, title: 'HTTPS em Toda a Rede', desc: 'TLS/SSL ativo em todos os pontos de presença para tráfego sempre seguro.' },
    { icon: Activity, title: 'Analytics em Tempo Real', desc: 'Estatísticas detalhadas de tráfego, cache hits e performance por região.' },
    { icon: Database, title: 'Compressão Automática', desc: 'Compressão Gzip e Brotli automática para reduzir o tamanho dos ficheiros.' },
  ]
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            ...
            <h1 className="text-4xl lg:text-6xl font-black text-white leading-tight mb-6">
              CDN <span style={{ color: '#F5B700' }}>Premium Global</span>
            </h1>
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Velocidade global com distribuição de conteúdo em mais de 50 pontos de presença.
            </p>
