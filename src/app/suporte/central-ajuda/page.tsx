...
import { BookOpen, Search, Headphones, MessageCircle, Globe, Shield, Zap, RefreshCw, Activity } from 'lucide-react'
...
export default function CentralAjudaPage() {
  const features = [
    { icon: BookOpen, title: 'Guias Completos', desc: 'Documentação detalhada para todos os nossos produtos e funcionalidades.' },
    { icon: Search, title: 'Pesquisa Rápida', desc: 'Encontre qualquer resposta em segundos com a nossa pesquisa inteligente.' },
    { icon: Headphones, title: 'Suporte Humano', desc: 'Quando a documentação não chega, a nossa equipa está sempre disponível.' },
    { icon: MessageCircle, title: 'Chat ao Vivo', desc: 'Converse em tempo real com um técnico especialista pelo chat.' },
    { icon: Globe, title: 'Domínios e DNS', desc: 'Tutoriais completos sobre registo de domínios e configuração de DNS.' },
    { icon: Shield, title: 'Segurança', desc: 'Guias de segurança para proteger o seu site e e-mail contra ameaças.' },
    { icon: Zap, title: 'Início Rápido', desc: 'Guias de início rápido para estar operacional em menos de 10 minutos.' },
    { icon: RefreshCw, title: 'Resolução de Problemas', desc: 'Guias de troubleshooting para os problemas mais comuns.' },
    { icon: Activity, title: 'Status do Sistema', desc: 'Acompanhe a disponibilidade dos serviços em tempo real.' },
  ]
  return (
    <>
      <Header />
