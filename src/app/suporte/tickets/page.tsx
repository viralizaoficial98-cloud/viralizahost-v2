...
export const metadata: Metadata = {
  title: 'Abrir Ticket de Suporte | ViralizaHost',
  description: 'A nossa equipa técnica responde em menos de 2 horas. Estamos sempre aqui.',
}

const features = [
  { icon: Mail, title: 'Ticket por E-mail', desc: 'Resposta direta na sua caixa de entrada.' },
  { icon: Shield, title: 'Prioridade Alta', desc: 'Tickets urgentes tratados em menos de 1 hora.' },
  { icon: Globe, title: 'Chat ao Vivo', desc: 'Para questões rápidas use o chat em tempo real.' },
  { icon: Zap, title: 'Resposta Rápida', desc: 'SLA de 2 horas para todos os planos.' },
  { icon: RefreshCw, title: 'Acompanhamento', desc: 'Acompanhe o estado do seu ticket a qualquer hora.' },
  { icon: Lock, title: 'Dados Seguros', desc: 'Todas as comunicações são encriptadas.' },
  { icon: Database, title: 'Histórico', desc: 'Acesso a todos os tickets anteriores.' },
  { icon: Gauge, title: 'Níveis de Prioridade', desc: 'Baixo, Normal, Alto e Urgente disponíveis.' },
  { icon: Activity, title: 'Equipa Técnica', desc: 'Especialistas em hosting, e-mail e servidores.' },
]
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            ...
            <h1 className="text-4xl lg:text-6xl font-black text-white leading-tight mb-6">
              Abrir Ticket <span style={{ color: '#F5B700' }}>de Suporte</span>
            </h1>
