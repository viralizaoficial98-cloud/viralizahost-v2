...
import { BookOpen, Search, Wrench, Globe, Shield, Server, Zap, Lock, RefreshCw } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Base de Conhecimento — ViralizaHost',
  description: 'Tutoriais, guias e respostas para todas as suas dúvidas técnicas.',
}

export default function BaseConhecimentoPage() {
  const features = [
    { icon: BookOpen, title: 'Tutoriais Passo-a-Passo', desc: 'Guias detalhados para configurar WordPress, e-mail, domínios e muito mais.' },
    { icon: Search, title: 'Pesquisa Rápida', desc: 'Encontre qualquer artigo rapidamente com a nossa pesquisa inteligente.' },
    { icon: Wrench, title: 'Guias Técnicos', desc: 'Documentação técnica para configurações avançadas de servidor e DNS.' },
    { icon: Globe, title: 'Domínios e DNS', desc: 'Tudo sobre registo de domínios, propagação DNS e configuração de registos.' },
    { icon: Shield, title: 'Segurança', desc: 'Como proteger o seu site, configurar SSL e ativar proteções de segurança.' },
    { icon: Server, title: 'Gestão de Servidor', desc: 'Guias para VPS, cPanel, WHM e gestão avançada de infraestrutura.' },
    { icon: Zap, title: 'Performance', desc: 'Otimize a velocidade do seu site com cache, CDN e compressão de imagens.' },
    { icon: Lock, title: 'E-mail e SSL', desc: 'Configuração de e-mail corporativo, SPF, DKIM, DMARC e certificados SSL.' },
    { icon: RefreshCw, title: 'Backup e Restauro', desc: 'Como criar, agendar e restaurar backups do seu site e base de dados.' },
  ]
        ...
        <section className="relative overflow-hidden pt-32 pb-20" style={{ background: 'linear-gradient(160deg,#090909 0%,#111 60%,#0d0d0d 100%)' }}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-4xl">
            ...
            <p className="text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Tutoriais, guias e respostas para todas as suas dúvidas técnicas.
            </p>
