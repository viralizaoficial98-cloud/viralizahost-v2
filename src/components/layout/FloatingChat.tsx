...
export function FloatingChat({ pageContext }: { pageContext?: string } = {}) {
  ...
  return (
    ...
    <a
      ...
      className="fixed z-50 transition-all active:scale-95 hover:scale-105"
      style={{ bottom: 24, left: 24 }}
    >
      <div
        className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-[0_8px_32px_rgba(37,211,102,0.40)]"
      ...
      >
        <svg viewBox="0 0 24 24" width="30" height="30" fill="white">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.136.561 4.14 1.535 5.876L.057 23.63a.5.5 0 00.614.612l5.857-1.53A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.9a9.886 9.886 0 01-5.031-1.374l-.36-.214-3.742.979.999-3.645-.235-.374A9.865 9.865 0 012.1 12C2.1 6.533 6.533 2.1 12 2.1c5.466 0 9.9 4.433 9.9 9.9 0 5.466-4.434 9.9-9.9 9.9z"/>
        </svg>
        <span className="absolute bottom-0.5 right-0.5 w-3.5 h-3.5 bg-green-300 border-2 border-white rounded-full" />
      </div>
    </a>

    {/* AI Chat (Cizesa) — fixed bottom-right */}
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <div className="flex flex-col items-end gap-3">
        ...
        <a
          ...
          rel="noopener noreferrer"
          aria-label="Contactar pelo WhatsApp"
          className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-[0_8px_32px_rgba(37,211,102,0.40)] transition-all active:scale-95 hover:scale-105"
          style={{ background: '#25D366' }}
        >
          <svg viewBox="0 0 24 24" width="30" height="30" fill="white" aria-hidden="true">
            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/>
            <path d="M12 0C5.373 0 0 5.373 0 12c0 2.126.558 4.121 1.533 5.851L.057 23.547a.75.75 0 0 0 .921.921l5.696-1.476A11.946 11.946 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.697 9.697 0 0 1-5.031-1.402l-.36-.214-3.733.968.992-3.622-.235-.373A9.699 9.699 0 0 1 2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/>
          </svg>
          <span className="absolute bottom-0.5 right-0.5 w-3.5 h-3.5 bg-green-300 border-2 border-white rounded-full" />
        </a>
      </div>
